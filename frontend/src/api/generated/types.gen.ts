...
export type FormFieldType = 'SHORT_TEXT' | 'LONG_TEXT' | 'NUMBER' | 'SINGLE_CHOICE' | 'MULTIPLE_CHOICE' | 'RATING';
...
export type ListPublishedFormsResponse = ListPublishedFormsResponses[keyof ListPublishedFormsResponses];
...
export type BeginGoogleLoginError = BeginGoogleLoginErrors[keyof BeginGoogleLoginErrors];
